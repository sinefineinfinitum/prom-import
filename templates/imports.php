                ...
                <tr data-id="<?php echo (int)$sinefine_promimport_import->getId(); ?>">
                    ...
                    <td class="actions-cell">
                        <div class="actions-primary">
                            <button type="button" class="button button-small run-import" 
                                    data-id="<?php echo (int)$sinefine_promimport_import->getId(); ?>">
                                <span class="dashicons dashicons-controls-play"></span> <?php echo esc_html(__('Run Import', 'spss12-import-prom-woo')); ?>
                            </button>
                            <button type="button" class="button button-small sync-prices" 
                                    data-id="<?php echo (int)$sinefine_promimport_import->getId(); ?>">
                                <span class="dashicons dashicons-update"></span> <?php echo esc_html(__('Sync prices', 'spss12-import-prom-woo')); ?>
                            </button>
                            <a href="<?php echo esc_url(admin_url('admin.php?page=prom-products-importer&import_id=' . (int)$sinefine_promimport_import->getId())); ?>" class="button button-small">
                                <span class="dashicons dashicons-upload"></span> <?php echo esc_html(__('Manual Import', 'spss12-import-prom-woo')); ?>
                            </a>
                        </div>
                        <div class="actions-secondary">
                            <a href="<?php echo esc_url(admin_url('admin.php?page=prom-edit-import&id=' . (int)$sinefine_promimport_import->getId())); ?>" class="button button-small edit-import">
                                <span class="dashicons dashicons-edit"></span> <?php echo esc_html(__('Edit', 'spss12-import-prom-woo')); ?>
                            </a>
                            <button type="button" class="button button-small button-link-delete delete-import" 
                                    data-id="<?php echo (int)$sinefine_promimport_import->getId(); ?>">
                                <span class="dashicons dashicons-trash"></span> <?php echo esc_html(__('Delete', 'spss12-import-prom-woo')); ?>
                            </button>
                        </div>
                    </td>
                </tr>
