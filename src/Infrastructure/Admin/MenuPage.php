...
class MenuPage
{
    public function register(): void
    {
	    if (is_admin()) {
		    add_menu_page(
			    esc_html(__('Prom Ua Importer Catalogs Settings', 'prom-import')),
			    esc_html(__('Prom Ua Importer', 'prom-import')),
			    'manage_options',
			    'prom-importer',
		    ...
		    add_submenu_page(
			    'prom-importer',
			    esc_html(__('Products Importer', 'prom-import')),
			    esc_html(__('Products Importer', 'prom-import')),
			    'manage_options',
    ...
    public function register_settings(): void
    {
	    add_settings_section(
		    ...
		    esc_html(__('General Settings', 'prom-import')),
	    ...
	    add_settings_field(
		    ...
		    esc_html(__('Prom.ua export XML URL', 'prom-import')),
